...
const EditarClienteS = () => {
  ...
  const telefonoS = document.getElementById("telefono");
  const correoS = document.getElementById("correo");
  const barrioS = document.getElementById("barrio");
  ...
  const actualizarCliente = async (e) => {
    ...
    if (
      !documentId.test(documentoj.value) ||
      !letras.test(nombreS.value, apellidoS.value) ||
      !cel.test(telefonoS.value) ||
      !email.test(correoS.value) ||
      !letraNum.test(barrioS.value, direccionS.value) ||
      !url.test(fotoS.value)
    ) {
      e.preventDefault();
    } else {
